...
def test_operation(a: int | None, b: int | None, expected: int | None) -> None:
    received = operation(a, b)
    assert received == expected, f'Test for a={a}, b={b} failed: expected result is {expected}, received {received}'